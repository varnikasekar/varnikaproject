...
public class OnlineExam {
    ...
    static String[][] questions = {
            {"Which company developed Java?", "Sun Microsystems", "Microsoft", "Sun Microsystems"},
            {"Java was released in which year?", "1995", "2005", "1995"},

            {"Which method is entry point of Java program?", "main()", "start()", "main()"},
            {"Which keyword is used for class inheritance?", "extends", "implements", "extends"},

            {"Which package contains Scanner class?", "java.util", "java.io", "java.util"},
            {"Which operator is used for comparison?", "==", "=", "=="},

            {"Which keyword stops loop?", "break", "stop", "break"},
            {"Which data type stores true/false?", "boolean", "int", "boolean"},

            {"Which collection stores unique values?", "Set", "List", "Set"},
            {"Which keyword is used to handle exception?", "try", "error", "try"}
    };
    ...
    static void startExam() {
        ...
        JLabel timerLabel = new JLabel("Time Left: 60 sec");
